			...
			<main className="main">
				...
				<section className={styles.contactsPage}>
					<div className="container">
						<h1 className={styles.contactsPage__title}>Адреса магазинов в Чите</h1>
						<div className={styles.contactsPage__content}>
							<div className={cl(styles.contactsPage__item, styles.itemContactsPage)}>
								<Link href="mailto:fortuna-mebel75@mail.ru" className={styles.itemContactsPage__link}>
